...
async function loginWithHashpack() {
    try {
        // Log step: Starting login process
        console.log("Starting login with Hashpack...");
        ...
        // Log step: Initializing HashConnect
        console.log("Initializing HashConnect...");
        await hashconnect.init(appMetadata, "testnet", true); // testnet or mainnet based on environment
        // Log step: Connecting to local wallet
        console.log("Connecting to local wallet...");
        const connectionData = await hashconnect.connectToLocalWallet();
        // Log step: Successfully connected
        console.log("Connected successfully!", connectionData);
        // Display account ID
        const accountId = connectionData.accountIds[0];
        document.getElementById("account-id").textContent = `Account ID: ${accountId}`;
    } catch (error) {
        console.error("Login failed:", error);
        document.getElementById("error-message").textContent = "Failed to log in. Please check the console for errors.";
    }
}
// Attach the login function to the button
document.getElementById("login-button").addEventListener("click", loginWithHashpack);

},{}]},["hPIHA","igcvL"], "igcvL", "parcelRequire22df")
